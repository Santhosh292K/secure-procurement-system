            ...
            <ProtectedRoute allowedRoles={['admin']}>
                <DashboardLayout>
                    <div className="text-center py-12">
                        ...
                        <h2 className="text-2xl font-bold text-foreground mb-2">Error Loading Approval</h2>
                        <p className="text-muted-foreground mb-6">{error || 'Approval not found'}</p>
                        <Link
                                ...
                                <div className="space-y-4">
                                    <div>
                                        <div className="flex items-center gap-2 text-muted-foreground mb-1">
                                            ...
                                            <span className="text-sm">Assigned Approver</span>
                                        </div>
                            ...
                            <div className="bg-primary/5 border border-primary/20 rounded-lg p-4">
                                <div className="flex items-start gap-2">
                                    ...
                                    <p className="text-primary text-sm">
                                        You are viewing this as an Administrator. This is a read-only view of the approval process.
                                    </p>
                                </div>
                            </div>
                        </div>
